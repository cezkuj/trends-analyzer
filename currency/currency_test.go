...
func TestGetRatesSeries(t *testing.T) {
	...
	testCases := []struct {
		...
		{"EUR", "USD", time.Date(2018, 01, 02, 0, 0, 0, 0, time.UTC), time.Date(2018, 01, 02, 0, 0, 0, 0, time.UTC), 0.8284},
		{"USD", "EUR", time.Date(2018, 01, 02, 0, 0, 0, 0, time.UTC), time.Date(2018, 01, 02, 0, 0, 0, 0, time.UTC), 1.2071},
	}
